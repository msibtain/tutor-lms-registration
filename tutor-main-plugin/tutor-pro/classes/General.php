...
class General {
	...
	public function extend_settings_option( $attr ) {
		...
		$attr['advanced']['blocks'][0]['fields'][] = array(
			...
			'label_title' => '',
			'default'     => 'off',
			'desc'        => __( 'Enable to hide WordPress Admin Bar from frontend and prevent instructors from accessing WP Admin panel.', 'tutor' ),
		);
		...
		$attr['course']['blocks']['block_quiz']['fields'][] = array(
			...
			'type'    => 'toggle_switch',
			'label'   => __( 'Hide Quiz Details From Students', 'tutor' ),
			'default' => 'off',
